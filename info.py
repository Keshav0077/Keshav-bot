...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002393184501') #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002031329869'-1002428058754'-1002393184501') # request channel id ( make sure bot is admin ).
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/Download7movie')
